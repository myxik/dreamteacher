# Gracefully and thankfully stolen from https://github.com/openai/guided-diffusion
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps, y=None):
        ...
        for module_idx, module in enumerate(self.output_blocks):
            ...
            h = module(h, emb)
            if module_idx+1 in self.modules_to_extract:
                # print(module.__class__.__name__)
                extracted_features.append(h)
        h = h.type(x.dtype)
        extracted_features.reverse()
        return self.out(h), extracted_features
